  ...
  return (
    <div className="space-y-6 flex flex-col h-full relative">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-semibold text-primary">Task Manager</h1>
        ...
        <DragDropContext onDragEnd={handleDragEnd}>
          <div className="grid grid-cols-4 gap-6 pb-4 flex-1 items-start h-[calc(100vh-200px)]">
            {STATUSES.map(statusCol => (
              <div key={statusCol} className="bg-secondary/30 rounded-xl p-4 flex flex-col max-h-full border border-border/50">
